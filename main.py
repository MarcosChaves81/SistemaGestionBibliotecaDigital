...
def login():
    ...
    if opcion == "1":
        ...
        if usuario and clave == CLAVE_USUARIO:
            ...
            return "usuario", sistema, usuario
        else:
        ...
        if opcion == "1":
            ...
            while True:
                ...
                if op == "1":
                    ...
                    sistema.gestion_libros.agregar(
                        "Admin",
                        titulo,
                        autor,
                        isbn,
                    ...
                    sistema.gestion_libros.modificar(
                        "Admin",
                        isbn,
                        titulo,
                        autor,
            ...
            while True:
                ...
                if op == "1":
                    ...
                    sistema.gestion_usuarios.agregar(
                        "Admin",
                        nombre,
                        apellido,
                        dni,
                    ...
                    sistema.gestion_usuarios.modificar(
                        "Admin",
                        dni,
                        nombre,
                        apellido,
...
def menu_usuario(sistema, usuario):
    ...
    while True:
        ...
        if opcion == "1":
            ...
            try:
                sistema.gestion_prestamos.registrar_prestamo(
                    usuario.nombre,
                    usuario.dni,
                    isbn
                )
            ...
            try:
                sistema.gestion_prestamos.registrar_devolucion("sistema",
                    isbn
                )
                print("Préstamo devuelto con éxito.")

            except Exception as e:
                print(f"Error: {e}")

        elif opcion == "0":
            print("Saliendo del menú usuario...")
            break
